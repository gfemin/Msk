...
import os
token = '8430139457:AAGB1Sntv8Lr09MCQ0jbE3Y-hLm7uWU6BEc'
bot=telebot.TeleBot(token,parse_mode="HTML")
@bot.message_handler(commands=["start"])
def start(message):
	if not str(message.chat.id) == '1915369904':
		bot.reply_to(message, "You cannot use the bot to contact developers to purchase a bot subscription @GFEMin")
		return
